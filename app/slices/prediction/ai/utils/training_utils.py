...
from utils.vector_utils.randomize_utils import (
    EgoFieldRandom,
    PedestrianFieldRandom,
    RouteFieldRandom,
    VehicleFieldRandom
)
from utils.vector_utils.utils_function import get_tl_state
...
def get_train_val_data(
    ...
    if val_set_size > 0:
        ...
        train_data = train_dataset["train"].shuffle(seed=42)
        train_data = train_data.map(
            generate_and_tokenize_prompt, remove_columns=[], num_proc=1
        )
        val_data = None
